...
// `permissionDecision: "ask"` with itemized failure reasons if any check
// fires. The auto-tagger (PostToolUse, § 5.8) handles the no-prefix case
// after a clean write — this gate must NOT reject lines that are otherwise
// well-formed but lack a bucket prefix.
//
// Four checks:
